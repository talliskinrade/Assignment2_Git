...
synth_design -top tb_cmdProc_interim -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef tb_cmdProc_interim.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file tb_cmdProc_interim_utilization_synth.rpt -pb tb_cmdProc_interim_utilization_synth.pb"
